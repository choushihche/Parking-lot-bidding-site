...
<body>
  ...
  <div class="container">
	...
	<p class="font-weight-bold">If you are member,you can fill in the message field directly!</p>
        ...
        <form name="sentMessage" id="contactForm" action="" method="post">
          ...
          <div class="form-group">
            <button type="submit" class="btn btn-primary" onclick="getmess()">Send</button>
          </div>
        </form>
      </div>
    </div>
...
function getmess(){
	...
	location.href="feeback.php?name="+name+"&phone="+phone+"&mail="+mail+"&day="+day+"&message="+message;
}
</script>
</html>
